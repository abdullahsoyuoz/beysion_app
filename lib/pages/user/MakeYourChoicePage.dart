...
class MakeYourChoicePage extends StatefulWidget {
  @override
  _MakeYourChoicePageState createState() => _MakeYourChoicePageState();
}

class _MakeYourChoicePageState extends State<MakeYourChoicePage> {
          ...
          children: [
            ...
            AutoSizeText(
              ...
              style: GoogleFonts.overpass(
                  color:
                      index == 1 ? Colors.white : BeysionColors.overlay,
                  fontSize: 16),
              minFontSize: 5,
            ),
            SizedBox(width: getSize(context, true, 5/415),),
    ...
    return ListView(
      ...
      children: [
        Padding(
          ...
          child: Text(isYourAddressVisible == true
              ? "Lieferauswahl"
                            ...
                            child: Padding(
                              ...
                              child: Stack(
                                children: [
                                  Container(
                                    width: getSize(context, true, 1),
                                    height: getSize(context, true, 180 / 415),
                                    decoration: BoxDecoration(
                                      color: Colors.white,

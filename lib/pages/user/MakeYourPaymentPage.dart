...
class MakeYourPaymentPage extends StatefulWidget {
  @override
  _MakeYourPaymentPageState createState() => _MakeYourPaymentPageState();
}

class _MakeYourPaymentPageState extends State<MakeYourPaymentPage> {
  ...
  void initState() {
    ...
    _cardNumberTextFormFieldController = MaskedTextController(mask: '0000-0000-0000-0000');
  }
                  ...
                  children: [
                    ...
                    AutoSizeText(
                      ...
                      style: GoogleFonts.overpass(
                          color:
                          index == 2 ? Colors.white : BeysionColors.overlay,
                          fontSize: 14),
                      minFontSize: 5,
                    )
                  ],
                  ...
                  children: [
                    ...
                    Expanded(
                      ...
                      child: RaisedButton(
                        ...
                        onPressed: () async {
                          settingRepo.toastWidget("Ordnung schaffen...", Colors.green);
                          ...
                          SharedPreferences testPref = await SharedPreferences.getInstance();
                          String tokenData = testPref.getString("sessionToken");
                          BasketSendData sendDataEntity = new BasketSendData();
                          List<BasketProductSelect> basketSelectList = new List();
                          for(var dataIn in settingRepo.mapBasketSendDataEntity.value.entries.toList()){
                            ...
                            print('PAYMENNTNTTT --- ${dataIn.key} -- saatlerii ${dataIn.value.time}');
                          }
                          ...
                          if(baseResponse is OkResponse){
                            ...
                            print('BAŞARILIIII ${baseResponse.body}');
                            try{
                              if (baseResponse is OkResponse) {
                                    ...
                                    for (var dataStr in dataList) {
                                      ...
                                      if (model != null) {
                                        ...
                                        Navigator.push(
                                            context,
                                            MaterialPageRoute(
                                              builder: (context) => PaymentCompletedPage(newDataList),
                                            ));
                ...
                Align(
                  ...
                  child: Padding(
                    ...
                    child: Text(
                      "General Info",
                      style:
                      GoogleFonts.overpass(fontSize: 17, fontWeight: FontWeight.w300),
                    ),
                  ),
                ),
                Divider(),
  ...
  buildPaymentBody(BuildContext context) {
    return Padding(
      ...
      child: ListView(
        ...
        padding: EdgeInsets.symmetric(
          //horizontal: getSize(context, true, 20 / 415),
          vertical: getSize(context, true, 50 / 415),
        ),
        children: [
          Padding(
            padding: EdgeInsets.only(
            ...
            child: Text("Lieferauswahl", style: GoogleFonts.overpass(
                fontSize: 15,
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        contentPadding: EdgeInsets.only(
                            left: getSize(context, true, 10 / 415), right: 0),
                        isDense: true,
                        filled: true,
                        border: OutlineInputBorder(
                          borderSide: BorderSide(
  ...
  buildCreditCard(BuildContext context, FakeCreditCard item, int index, int currentIndex, bool isSelected) {
    return InkWell(
      child: Container(

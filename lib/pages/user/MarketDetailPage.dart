...
class MarketDetailPage extends StatefulWidget {
  ...
  MarketDetailPage(this.marketsAllEntity);
  @override
  _MarketDetailPageState createState() => _MarketDetailPageState();
}

class _MarketDetailPageState extends State<MarketDetailPage>  with SingleTickerProviderStateMixin {
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            ...
                                            child: Text("${widget.marketsAllEntity.name}", style: GoogleFonts.overpass(fontSize: 16, fontWeight: FontWeight.w700),),
                                          ),
                                        ],
                                      ),
                                      Container(
                                        ...
                                        child: Center(child: Text("${widget.marketsAllEntity.avgScore}", style: GoogleFonts.overpass(color: BeysionColors.purple, fontWeight: FontWeight.w700),)),
                                      )
                                    ],
                                  ),
                                  Padding(
                                    ...
                                    child: Row(
                                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                      children: [
                                        Expanded(child: Text("${widget.marketsAllEntity.fulladdress}", style: GoogleFonts.overpass(color: Colors.grey.shade700, fontSize: 12),)),
                                        OutlineButton(
                                          child: Center(
                                            child: Row(
                                              children: [
                                                ...
                                                Padding(
                                                  ...
                                                  child: Text("Karte öffnen", style: GoogleFonts.overpass(color: Colors.grey.shade700, fontSize: 13),),
                                                )
                                              ],
                                            ),
                                          ),
                                            ...
                                            child: Center(
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  Text("${widget.marketsAllEntity.point1}", style: GoogleFonts.overpass(color: BeysionColors.purple, fontSize: 15, fontWeight: FontWeight.w800),),
                                                ],
                                              ),
                                            ),
                                          ),
                                            ...
                                            child: Center(
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  Text("${widget.marketsAllEntity.point2}", style: GoogleFonts.overpass(color: BeysionColors.purple, fontSize: 15, fontWeight: FontWeight.w800),),
                                                ],
                                              ),
                                            ),
                                          ),
                                            ...
                                            child: Center(
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  Text("${widget.marketsAllEntity.point3}", style: GoogleFonts.overpass(color: BeysionColors.purple, fontSize: 15, fontWeight: FontWeight.w800),),
                                                ],
                                              ),
                                            ),
                                          ),
              ...
              GridView.count(
                ...
                children: marketCategoryDataList.map((categoryEntity) => InkWell(
                  onTap: (){
                    ...
                    //Navigator.push(context, CupertinoPageRoute(builder: (context) => MarketProductCategoryPage(categoryEntity,widget.marketsAllEntity),));
                  },
                  child: Container(
                                      ...
                                      Expanded(
                                        ...
                                        child: TextField(
                                          ...
                                          decoration: InputDecoration(
                                              ...
                                              hintStyle: GoogleFonts.overpass(color: Colors.grey.shade300),

...
import 'UserForgotPasswordPage.dart';
        ...
        children: [
          ...
          InkWell(
            ...
            onTap: () {
              ...
              settingRepo.pageViewState.value.pageController.animateToPage(10, duration: Duration(milliseconds: 100), curve: Curves.easeInOutExpo);
            },
          ),
          SizedBox(
            height: getSize(context, true, 10 / 415),
            ...
            if (response.body["response"] == "success") {
              if (response.body["result"] != null) {
                ...
                if (tokenEntity != null) {
                  ...
                  Navigator.pop(context);
                  Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => MainPageView()));
                } else {
                  Navigator.pop(context);

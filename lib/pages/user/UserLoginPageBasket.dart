...
class UserLoginPageBasket extends StatefulWidget {
  @override
  _UserLoginPageBasketState createState() => _UserLoginPageBasketState();
}

class _UserLoginPageBasketState extends State<UserLoginPageBasket> {
    ...
    return Padding(
      ...
      child: Column(
        children: [
          ...
          Padding(
            padding: EdgeInsets.only(
                top: getSize(context, true, 30/415)
            ),
            child: Text(
              "Ihre Bestellung \nist bereit!",
              textAlign: TextAlign.center,

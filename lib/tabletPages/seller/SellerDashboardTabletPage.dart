...
class SellerDashboardTabletPage extends StatefulWidget {
  @override
  _SellerDashboardTabletPageState createState() =>
      _SellerDashboardTabletPageState();
}

class _SellerDashboardTabletPageState
    extends State<SellerDashboardTabletPage> {
  var selectedPopupmenuValue = 0;
                          ...
                          child: Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                if (FakeData.fakeHeuteList.length == 0) SizedBox(height: 150,) else SizedBox(
                                  height: 150,
                                  child: ClipRRect(
                                    borderRadius: BorderRadius.circular(15),
                          ...
                          child: Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                if (FakeData.fakeUmsatz7TageList.length == 0) SizedBox(height: 150) else SizedBox(
                                      height: 150,
                                      child: ClipRRect(
                                  borderRadius: BorderRadius.circular(15),
                                  child: SfCartesianChart(
                          ...
                          child: Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                if (FakeData.fakeUmsatz30TageList.length == 0) SizedBox(height: 150) else SizedBox(
                                  height: 150,
                                  child: ClipRRect(
                                      borderRadius: BorderRadius.circular(15),
                                      child: SfCartesianChart(
                          ...
                          child: Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                if (FakeData.fakeGesamtumsatzList.length == 0) SizedBox(height: 150,) else SizedBox(
                                  height: 150,
                                  child: ClipRRect(
                                    borderRadius: BorderRadius.circular(15),
                                    child: SfCartesianChart(
                                                    ...
                                                    text: TextSpan(
                                                        ...
                                                        children: [
                                                          TextSpan(
                                                              ...
                                                              style: GoogleFonts.overpass(color: BeysionColors.purple, fontSize: 15, fontWeight: FontWeight.w600)
                                                          )
                                                        ]
                                                    ),
                                                  )
                            ...
                            child: Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Divider(),
                                    if (FakeData.FakePieChartLetztenHeutelist.length == 0) SizedBox( height: 560,) else SizedBox(
                                      height: 560,
                                      child: Column(
                                        children: [
                                          SfCircularChart(
                            ...
                            child: Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Divider(),
                                    if (FakeData.FakePieChartLetzten7list.length == 0) SizedBox( height: 560,) else SizedBox(
                                      height: 560,
                                      child: Column(
                                        children: [
                                          SfCircularChart(
                            ...
                            child: Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Divider(),
                                    if (FakeData.FakePieChartLetzten30list.length == 0) SizedBox(height: 560,) else SizedBox(
                                      height: 560,

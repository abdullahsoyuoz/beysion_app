...
class MarketDetailHomeTabletPage extends StatefulWidget {
  int marketId;

  MarketDetailHomeTabletPage(this.marketId);
  @override
  _MarketDetailHomeTabletPageState createState() => _MarketDetailHomeTabletPageState();
}

class _MarketDetailHomeTabletPageState extends State<MarketDetailHomeTabletPage> with SingleTickerProviderStateMixin{
                                          ...
                                          Row(
                                            ...
                                            children: [
                                              ...
                                              Padding(
                                                ...
                                                child: Text("${marketDetailEntity.name}", style: TextStyle(fontSize: 18, fontWeight: FontWeight.w700),),
                                              ),
                                            ],
                                          ),
                                          Container(
                                            ...
                                            child: Center(child: Text("${marketDetailEntity.avgScore}", style: TextStyle(color: BeysionColors.purple, fontSize:16,fontWeight: FontWeight.w700),)),
                                          )
                                        ],
                                      ),
                                      OutlineButton(
                                  ...
                                  Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                                  ...
                                                  child: Center(
                                                    child: Column(
                                                      ...
                                                      children: [
                                                        ...
                                                        Text("${marketDetailEntity.point1}", style: GoogleFonts.overpass(color: BeysionColors.purple, fontSize: 16, fontWeight: FontWeight.w800),),
                                                      ],
                                                    ),
                                                  ),
                                                ),
                                                  ...
                                                  child: Center(
                                                    child: Column(
                                                      ...
                                                      children: [
                                                        ...
                                                        Text("${marketDetailEntity.point2}", style: GoogleFonts.overpass(color: BeysionColors.purple, fontSize: 16, fontWeight: FontWeight.w800),),
                                                      ],
                                                    ),
                                                  ),
                                                ),
                                                  ...
                                                  child: Center(
                                                    child: Column(
                                                      ...
                                                      children: [
                                                        ...
                                                        Text("${marketDetailEntity.point3}", style: GoogleFonts.overpass(color: BeysionColors.purple, fontSize: 16, fontWeight: FontWeight.w800),),
                                                      ],
                                                    ),
                                                  ),
                                                ),
                                        ...
                                        Expanded(
                                          flex: 2,
                                          child: Text("${marketDetailEntity.address}", style: TextStyle(color: Colors.grey.shade700),),
                                        ),
                                      ],
                                    ),
                                  ),
              ...
              GridView.count(
                ...
                children: marketCategoryDataList.map((categoryEntity) => InkWell(
                  onTap: (){
                    ...
                    Navigator.push(context, CupertinoPageRoute(builder: (context) => MarketProductCategoryTabletPage(categoryEntity,entityAllMarket),));
                  },
                  child: Container(
                                            ...
                                            child: Container(
                                              ...
                                              child: Column(
                                                children: productSearchList.map((productEntity) =>
                                                    InkWell(
                                                      onTap: (){Navigator.push(context, MaterialPageRoute(builder: (context) => ProductDetailTabletPage(productEntity,marketId: widget.marketId)));},
                                                      child: Padding(
                                                        padding: const EdgeInsets.all(8.0),
                                                        child: Row(
                                                          crossAxisAlignment: CrossAxisAlignment.center,

...
class MarketProductCategoryTabletPage extends StatefulWidget {
  MarketCategoryEntity categoryEntity;
  MarketsAllEntity marketsAllEntity;
  MarketProductCategoryTabletPage(this.categoryEntity, this.marketsAllEntity);
  @override
  _MarketProductCategoryTabletPageState createState() => _MarketProductCategoryTabletPageState();
}

class _MarketProductCategoryTabletPageState extends State<MarketProductCategoryTabletPage> with SingleTickerProviderStateMixin {
                ...
                child: Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      Row(
                        children: [
                          Text("${widget.marketsAllEntity.name}", style: TextStyle(fontSize: 20, fontWeight: FontWeight.normal),),
                          Container(
                            ...
                            child: Center(child: Text("${widget.marketsAllEntity.avgScore}", style: TextStyle(color: BeysionColors.purple, fontWeight: FontWeight.w700),)),
                          )
                        ],
                      ),
                    ],

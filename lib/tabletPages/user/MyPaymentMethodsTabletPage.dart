...
class MyPaymentMethodsTabletPage extends StatefulWidget {
  @override
  _MyPaymentMethodsTabletPageState createState() => _MyPaymentMethodsTabletPageState();
}

class _MyPaymentMethodsTabletPageState extends State<MyPaymentMethodsTabletPage> {

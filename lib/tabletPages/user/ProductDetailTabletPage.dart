...
import 'package:beysion/constant/gallery_photo_view.dart';
...
class ProductDetailTabletPage extends StatefulWidget {
  ProductEntity productEntity;
  int marketId;

  ProductDetailTabletPage(this.productEntity, {this.marketId});

  @override
  _ProductDetailTabletPageState createState() =>
      _ProductDetailTabletPageState();
}

class _ProductDetailTabletPageState extends State<ProductDetailTabletPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
                  ...
                  child: Column(
                    children: [
                      Container(
                        ...
                        height: getSize(context, true, 0.4),
                            ...
                            CustomCarousel(
                              images: [
                                InkWell(
                                  ...
                                  child: Container(
                                    width: getSize(context, true, 1),
                                    height: getSize(context, true, 0.5),
                      ...
                      Column(
                        children: [
                          Padding(
                            ...
                            child: Row(
                              children: [
                                Expanded(child: Center(child: Text("Mindestpaketmenge", style: TextStyle(color: Colors.grey.shade500),))),
                                Expanded(child: Center(child: Text("Arbeitszeit (heute)", style: TextStyle(color: Colors.grey.shade500),))),
                              ],
                            ),
                          ),
                          Row(
                            children: [
                              Expanded(child: Center(child: Text("${marketDetailEntity.minimumSellPrice}", style: TextStyle(fontSize: 16),))),
                              Expanded(child: Center(child: Text("${marketDetailEntity.workingTimeNow}", style: TextStyle(fontSize: 16),))),
                            ],
                          ),
                          Padding(
                            padding: EdgeInsets.only(top: getSize(context, true, 15/360)),
                            child: Row(
                              children: [
                                Expanded(child: Center(child: Text("Vorbereitungszeit", style: TextStyle(color: Colors.grey.shade500),))),
                                Expanded(child: Center(child: Text("Service Wählen", style: TextStyle(color: Colors.grey.shade500),))),
                              ],
                            ),
                          ),
                          Row(
                            children: [
                              Expanded(child: Center(child: Text("${marketDetailEntity.preparingTime}", style: TextStyle(fontSize: 16),))),
                              Expanded(child: Center(child: Text("${marketDetailEntity.deliveryType}", style: TextStyle(fontSize: 16),))),
                            ],
                          ),
                        ],
                      ),
      ...
      bottomNavigationBar: AnimatedContainer(
        ...
        height:  widget.productEntity.selected == true ? getSize(context, true, 60/360) : getSize(context, true, 40/360),
        width: getSize(context, true, 1),
        padding: EdgeInsets.symmetric(horizontal: getSize(context, true, 20/360)),
        decoration: BoxDecoration(
        ...
        child:  widget.productEntity.selected == true ?
        Padding(
              padding: EdgeInsets.only(
                top: getSize(context, true, 10/360),
                bottom: getSize(context, true, 10/360),
                ...
                children: [
                  Expanded(
                    ...
                    child: widget.productEntity.discountPrice == null
                        ? Text("${widget.productEntity.price.toString().replaceAll(".", ",")} €", style: TextStyle( fontSize: 22, fontWeight: FontWeight.w500),)
                        : Row(
                      children: [
                        Container(
                          width: getSize(context, true, 25/360),
                          height: getSize(context, true, 25/360),
                          decoration: BoxDecoration(
                            color: BeysionColors.red,
                            borderRadius: BorderRadius.circular(10),
                          ),
                          child: Center(
                            child: Text("${fiyatYuzdeHesaplama(widget.productEntity)}", style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.w600),),
                          ),
                        ),
                        Padding(
                          padding: EdgeInsets.only(left: 8.0),
                          child: Column(
                            ...
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text("${widget.productEntity.price.toString().replaceAll(".", ",")} €", style: TextStyle(fontSize: 18, color: Colors.grey, decoration: TextDecoration.lineThrough),),
                              Text("${widget.productEntity.discountPrice.toString().replaceAll(".", ",")} €", style: TextStyle( fontSize: 22, fontWeight: FontWeight.w500),),
                            ],
                          ),
                        )
                      ],
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Center(child: Text("${productQuantity.toString()}", style: TextStyle(fontSize: 22),),),
                        ),
                        InkWell(
                          onTap: () async {
                            BasketService basketService = new BasketService();
                  ...
                  Expanded(
                    ...
                    child: SizedBox(
                      ...
                      child: FlatButton(
                        onPressed: () {
                          setState(() {
                            isAddCartButtonClicked = !isAddCartButtonClicked;
                          });
                        },
                        child: Center(child: Text("Zum Warenkorb", style: TextStyle(color: Colors.white),),),
              ...
              child: widget.productEntity.discountPrice == null
                ...
                children: [
                  Container(
                    ...
                    child: Center(
                      child: Text("${fiyatYuzdeHesaplama(widget.productEntity)}", style: TextStyle(color: Colors.white, fontSize: 22, fontWeight: FontWeight.w600),),
                    ),
                  ),
                  Padding(
                    padding: EdgeInsets.only(left: 8.0),
  ...
  Color statesColor(MarketDetailEntity marketDetailEntity) {
    try {
      return marketDetailEntity.avgScore > 9.5
          ? BeysionColors.rank1
          : marketDetailEntity.avgScore > 9.0
              ? BeysionColors.rank2
              : marketDetailEntity.avgScore > 8.5
                  ? BeysionColors.rank3
                  : marketDetailEntity.avgScore > 8.0
                      ? BeysionColors.rank4
                      : marketDetailEntity.avgScore < 8.0
                          ? BeysionColors.rank5
                          : Colors.red;
    } catch (e) {
      print('STATUS COLOR $e');
      return BeysionColors.rank1;
    }
  }
}
